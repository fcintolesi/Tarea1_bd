...
Agustin Fierro | N°Alumno: 24644978
...
# 1
A la variable "Restarts" le pusimos el nombre "Muertes", pues para nosotros generaba mas claridad.

# 2 
la funcion de inscribir equipos en torneos no funciona, ya que cuando poblamos la base de datos los llenamos todos.

# 3
Consideramos que no se van a eliminar o updatear variables.